...
@section('main')
    <form class="grid-x grid-padding-x grid-padding-y bg-white px-2" method="POST" action="{{route('questiontype.store')}}">
        @csrf
        @if (count($errors) > 0)
        ...
        @endif
        <label for="name" class="cell small-12 medium-2 font-bold" style="padding-bottom: 0">Name</label>
        <div class="cell small-12 medium-10">
            <input id="name" name="name" type="text" class="my-0" required>
        </div>
